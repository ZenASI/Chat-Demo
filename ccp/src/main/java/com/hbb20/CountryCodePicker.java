...
public class CountryCodePicker extends RelativeLayout {
    ...
    Language languageToApply = null;

    boolean dialogKeyboardAutoPopup = true;
    boolean ccpClickable = true;
    boolean autoDetectLanguageEnabled = true, autoDetectCountryEnabled = false, numberAutoFormattingEnabled = true, hintExampleNumberEnabled = false;
    ...
    private void applyCustomProperty(AttributeSet attrs) {
        ...
        try {
            ...
            autoDetectLanguageEnabled = a.getBoolean(R.styleable.CountryCodePicker_ccp_autoDetectLanguage, true);
